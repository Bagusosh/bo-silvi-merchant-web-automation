...
class SalesPerMenuTests(unittest.TestCase):
    def setUp(self) -> None:
        load_dotenv()
        ...
        self.title_menu_chart = 'Sales dari setiap menu'
    ...
    def test_check_report_menu_today(self):
        with self.driver as driver:
            ...
            try:
                ...
                logger.error("Check Report Menu Test Case Resulted Error")
                return

            driver.find_element(By.XPATH, self.sales_per_menu_page_xpath).click()
            ...
            try:
                _ = WebDriverWait(driver, 10).until(
                    EC.presence_of_element_located((By.XPATH, self.report_menu_chart_xpath))
                )
                page_exist = True
            except TimeoutException:
                logger.error("Check Report Menu Test Case Resulted Error")
            ...
            logger.success("Check Report Menu Today Test Case has been Tested")

    def test_check_report_menu_yesterday(self):
        with self.driver as driver:
            ...
            assert page_exist is True
            logger.success("Check Report Menu Yesterday Test Case has been Tested")

    def test_check_report_menu_this_week(self):
        with self.driver as driver:
            ...
            assert page_exist is True
            logger.success("Check Report Menu This Week Test Case has been Tested")

    def test_check_report_menu_last_week(self):
        with self.driver as driver:
            ...
            assert page_exist is True
            logger.success("Check Report Menu Last Week Test Case has been Tested")

    def test_check_report_menu_this_month(self):
        with self.driver as driver:
            ...
            assert page_exist is True
            logger.success("Check Report Menu This Month Test Case has been Tested")

    def test_check_report_menu_last_month(self):
        with self.driver as driver:
            ...
            assert page_exist is True
            logger.success("Check Report Menu Last Month Test Case has been Tested")

    def test_check_report_menu_this_year(self):
        with self.driver as driver:
            ...
            assert page_exist is True
            logger.success("Check Report Menu This Year Test Case has been Tested")

    def test_check_report_menu_last_year(self):
        with self.driver as driver:
